...
const SETTINGS_ROWS = [
  ...
  ["Refund WhatsApp", "Template name + a test send for the automatic “your refund has been processed” message", "WhatsApp"],
    ...
    <PageIn>
      ...
      <GroupCard icon="server" title="System" navPath="Sidebar → System">
        ...
        <PageEntry
          ...
          points={[
            "Saving one section — say, Refund WhatsApp — only ever touches that section's own fields. It cannot blank out an unrelated setting like a GST rate, even if that field happened to be empty on your screen at the time.",
      ...
      <Card style={{ marginTop: "6px" }}>
        ...
        <FaqItem q="I saved one setting and an unrelated one disappeared — will that happen again?">
          No. Every section on the Settings page saves independently — clicking Save under, say, "Refund WhatsApp" only ever submits that
