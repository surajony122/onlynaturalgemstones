          ...
          <TemplateCard icon={<Icon name="tag" size={15} color={brand.accent} />} title="GST Tax Invoice">
            ...
            {invoiceTab === "pdf" && (
              <>
                ...
                />
                <p style={{ ...hintStyle, marginTop: "6px" }}>
                  Rendered with a real headless Chromium (Puppeteer), so this HTML renders exactly like the preview
                  below — a &lt;style&gt; block and CSS classes work fine here, not just inline <code>style="..."</code>.
                </p>
                <div style={{ display: "flex", gap: "8px", marginTop: "6px", flexWrap: "wrap" }}>
